...
class NewsController extends Controller
{
    ...
    {
        return $this->webResponse($this->service->store($request), 'superAdmin.news');
    }
    ...
    {
        return $this->webResponse($this->service->update($request));
    }
    ...
    {
        return $this->webResponse($this->service->delete($encryptedNewsId), 'superAdmin.news');
    }
}

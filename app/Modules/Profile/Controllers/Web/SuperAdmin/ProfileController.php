...
class ProfileController extends Controller
{
    ...
    public function profile()
    {
        ...
        return view('super_admin.profile.content', $data);
    }
    ...
    public function update(UpdateProfileRequestRequest $request)
    {
        ...
        return $response['success'] ?
            $response['data']['verified'] ?
                redirect(route('superAdmin.profile'))->with($response['webResponse']):
    ...
    {
        return $this->webResponse( $this->service->updatePassword($request), 'superAdmin.profile');

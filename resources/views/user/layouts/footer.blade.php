                    ...
                    <div class="col-xxl-3 col-md-6 footer_col">
                        <div class="footer_questions">
                            ...
                            <div class="footer_list">
                                <ul>
                                    <li><a href="{{route('faq', 'about_us')}}" class="font-weight-bold text-white">About us</a></li>
                                    <li><a href="{{ route('contact') }}" class="font-weight-bold text-white">Contact Us</a></li>
                                    <li><a href="{{route('faq', 'offerings')}}" class="font-weight-bold text-white">Offers</a></li>
                                    <li><a href="{{route('faq', 'payment_information')}}" class="font-weight-bold text-white">Payment Information</a></li>
                                    <li><a href="{{route('faq', 'delivery_information')}}" class="font-weight-bold text-white">Delivery Information</a></li>
                                    <li><a href="{{route('faq', 'order_guideline')}}" class="font-weight-bold text-white">Order Guideline</a></li>
                                    <li><a href="{{route('faq', 'terms_and_conditions')}}" class="font-weight-bold text-white">Term & Conditions</a></li>
                                    <li><a href="{{route('faq', 'privacy_policy')}}" class="font-weight-bold text-white">Privacy Policy</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>

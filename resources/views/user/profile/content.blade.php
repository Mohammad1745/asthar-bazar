                            ...
                            <div class="main_extra_content main_extra_total">
                                ...
                                <ul class="main_extra_total_list content-toggle-0">
                                    ...
                                    <li class="d-flex flex-row align-items-center justify-content-start">
                                        ...
                                        <div class="main_extra_total_value ml-auto">{{$user->code}}</div>
                                    </li>
                                    <li class="d-flex flex-row align-items-center justify-content-start">
                                ...
                                <div class="main_form_container content-toggle-1">
                                    {{ Form::open(['route' => 'profile.update', 'method' => 'post', 'id' => 'profile_form', 'class' => 'main_form']) }}
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <!-- Name -->
                                ...
                                <div class="main_form_container content-toggle-2">
                                    {{ Form::open(['route' => 'profile.updatePassword', 'method' => 'post', 'id' => 'password_form', 'class' => 'main_form']) }}
                                    <div>
                                        <!-- Password -->

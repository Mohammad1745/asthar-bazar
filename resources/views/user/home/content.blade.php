...
@section('title', __('Home - '.TITLE_CORE))
                        ...
                        <div class="home_content_container">
                            <div class="home_content">
                                <div class="home_discount d-flex flex-row align-items-end justify-content-start">
                                    <div class="home_discount_num">{{$maxDiscount}}</div>
                                    <div class="home_discount_text" id="home_discount_text">upto <br><br>Discount on the</div>
                                </div>
                                <div class="home_title">New Collection</div>
                                <div class="button button_1 home_button trans_200"><a href="{{route('shop')}}">Shop NOW!</a></div>
                            </div>
                        </div>
                    </div>
                @endfor

                        ...
                        <div class="main_container">
                            <div class="main_extra_content main_extra_total">
                                ...
                                <div class="main_form_container content-toggle-1">
                                    {{ Form::open(['route' => 'superAdmin.profile.update', 'method' => 'post', 'id' => 'profile_form', 'class' => 'main_form']) }}
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <!-- Name -->
                                ...
                                <div class="main_form_container content-toggle-2">
                                    {{ Form::open(['route' => 'superAdmin.profile.updatePassword', 'method' => 'post', 'id' => 'password_form', 'class' => 'main_form']) }}
                                    <div>
                                        <!-- Password -->

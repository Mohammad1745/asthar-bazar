                            ...
                            <div class="main_extra_content main_extra_total">
                                ...
                                <ul class="main_extra_total_list">
                                    <li class="d-flex flex-row align-items-center justify-content-start">
                                        <div class="main_extra_total_title"><a href="{{route('superAdmin.profile')}}">Profile</a></div>
                                        <div class="main_extra_total_value ml-auto">{{$profilePercentage}}%</div>
                                    </li>
                                    <li class="d-flex flex-row align-items-center justify-content-start">
                                        <div class="main_extra_total_title"><a href="{{route('superAdmin.account.transactions')}}">Transactions</a></div>
                                        <div class="main_extra_total_value ml-auto">৳ {{$netProfit}}</div>
                                    </li>
                                </ul>
                            </div>
                        </div>

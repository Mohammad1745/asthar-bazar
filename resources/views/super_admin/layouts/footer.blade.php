                    ...
                    <div class="col-xxl-3 col-md-6 footer_col">
                        <div class="footer_questions">
                            ...
                            <div class="footer_list">
                                <ul>
                                    <li><a href="{{route('superAdmin.faq')}}" class="font-weight-bold text-white">About us</a></li>
                                    <li><a href="{{route('superAdmin.faq') }}" class="font-weight-bold text-white">Contact Us</a></li>
                                    <li><a href="{{route('superAdmin.faq')}}" class="font-weight-bold text-white">Offers</a></li>
                                    <li><a href="{{route('superAdmin.faq')}}" class="font-weight-bold text-white">Payment Information</a></li>
                                    <li><a href="{{route('superAdmin.faq')}}" class="font-weight-bold text-white">Delivery Information</a></li>
                                    <li><a href="{{route('superAdmin.faq')}}" class="font-weight-bold text-white">Order Guideline</a></li>
                                    <li><a href="{{route('superAdmin.faq')}}" class="font-weight-bold text-white">Term & Conditions</a></li>
                                    <li><a href="{{route('superAdmin.faq')}}" class="font-weight-bold text-white">Privacy Policy</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
